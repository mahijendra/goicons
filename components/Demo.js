                ...
                <main className="mt-8 mx-auto max-w-7xl px-4 sm:mt-24">
                    <div className="text-center flex justify-center flex-col">
                        <div className="text-3xl tracking-normal font-normal text-gray-900 sm:text-5xl md:text-6xl font-nunito">
                            <span className="block xl:inline text-gray-300 font-normal font-quicksand tracking-wide lg:text-6xl">Go Icons</span>{' '}
                          {/*  <span className="block text-indigo-600 xl:inline">online business</span>*/}
                        </div>

                        <p className="mt-3 max-w-md mx-auto text-base text-gray-300 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl font-nunito ">
                        ...
                        <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8 ">
                                <div className="justify-center">
                                    <a
                                        ...
                                        className="button button--nina  px-6 py-0 text-gray-400 hover:text-white relative block focus:outline-none border-2 rounded-full text-sm text-center font-semibold tracking-wider overflow-hidden font-nunito"
                                        data-text="Github"
                                    >
